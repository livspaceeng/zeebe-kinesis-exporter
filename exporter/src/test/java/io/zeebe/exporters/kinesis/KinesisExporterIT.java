...
import io.zeebe.exporters.kinesis.config.toml.TomlProducerConfig;
import io.zeebe.exporters.kinesis.serde.RecordIdDeserializer;
import io.zeebe.exporters.kinesis.serde.generic.GenericRecord;
import io.zeebe.exporters.kinesis.serde.generic.GenericRecordDeserializer;
...
public class KinesisExporterIT {
  ...
  private void startZeebeBroker() {
    ...
    exporterIntegrationRule.configure("kinesis", KinesisExporter.class, exporterConfiguration);
