...
import static io.zeebe.exporters.kinesis.config.parser.ConfigParserUtil.get;

import io.zeebe.exporters.kinesis.config.Config;
import io.zeebe.exporters.kinesis.config.ProducerConfig;
...
import io.zeebe.exporters.kinesis.config.toml.TomlRecordsConfig;
